...
namespace gestionaMelon.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            // si esta loguiado volver al index de la web
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, string mail)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    prop.mail = mail;
                    prop.fk_id_user = user.Id;
                    db.propUser.Add(prop);
                    db.SaveChanges();
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        // agrego mail a propUser
                        var prop = new propUser();
                        prop.fk_id_user = user.Id;
                        prop.mail = info.Email;
                        db.propUser.Add(prop);
                        db.SaveChanges();
